...
#Judul
st.title('Kalkulator Perhitungan Praktik Analisis Fisika')
st.write('---')

left_column, right_column = st.columns(2)
with left_column:
    st.write('Aplikasi ini berfungsi membantu dalam Perhitungan Analisis Fisika ')
with right_column:
    st.write('''
Kelompok 5 - 1B :
1. (2219048) : Cahyaning Fitriani Lestari
2. (2219054) : Cindy Shella Aprilia
3. (2219079) : Goodwill Christian Sitinjak
4. (2219080) : Hanif Ibrohim Sedyotomo
    ''')
st.write('---')
...
if tab == "Percobaan 1":
    ...
    stx.TabBarItemData(id="Hubungan Kepekatan dan Kerapatan Larutan Garam", description="", title="Hubungan Kepekatan dan Kerapatan Larutan Garam")
    ])
    ...
    st.latex(r'''Masukkan - Panjang - dan - Lebar - dalam - satuan - cm''')
